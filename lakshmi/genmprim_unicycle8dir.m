%{
each angle has 5 primitives
1 - short forward
2 - long forward
3 - forward and turn right
4 - forward and turn left
5 - short backward
%}

function[] = genmprim_unicycle(outfilename)
    UNICYCLE_MPRIM_8DEGS = 1;

    if UNICYCLE_MPRIM_8DEGS == 1
        resolution = 0.025;
        ...
        %1/16 theta change
        basemprimendpts0_c(4,:) = [8 1 1 forwardandturncostmult]; % I would may be want to have [6 2 1] instead why ??? not sure 
